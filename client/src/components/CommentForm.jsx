...
//     if (activateTagging) {
//       setTagValue(e.target.textContent)
//       return searchUsers(tagValue)
//     }
...
//     setTagValue('')
//     // setCommentValue('')
//     inputRef.current.textContent = commentValue
...
const CommentForm = props => {
  ...
  const handleTaggedUserClick = user => {
    ...
    const index = commentValue.lastIndexOf('@')
    const text = commentValue.slice(index)
    setCommentValue(commentValue.replace(text, 'ooooooo'))
